...
public class Knockback extends Kit {
    ...
    public Knockback() {
        super(
                "Knockback",
                "kit.skywars.solo.knockback",
                "kit.skywars.team.knockback",
                5000,
                5000/2
        );
    }
    ...
    public void apply(Player player) {
        player.getInventory().addItem(
                new ItemCreator(Material.STICK).addEnchant(Enchantment.KNOCKBACK, 2).build()
        );
    }
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Jogue seus inimigos longe com este kit.");
        lore.add("");
        ...
        net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.STICK));
