...
public class Specialist extends Kit {
    ...
    public Specialist() {
        super(
                "Especialista",
                "kit.skywars.solo.specialist",
                "kit.skywars.team.specialist",
                5000,
                2500
        );
    }
    ...
    public void apply(Player player) {
        ...
        player.getInventory().addItem(new ItemCreator(Material.ENCHANTED_BOOK).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 3).build());
        player.getInventory().addItem(new ItemStack(Material.EXP_BOTTLE, 64));
        player.getInventory().addItem(new ItemCreator(Material.ENCHANTED_BOOK).addEnchant(Enchantment.DAMAGE_ALL, 1).build());
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Tenha um kit de encantamento");
        lore.add("§7que irá te preparar para o combate!");
        lore.add("");
        ...
        net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.ANVIL));
        ...
        meta.setDisplayName("§aEspecialista");
        if (enchant) {
