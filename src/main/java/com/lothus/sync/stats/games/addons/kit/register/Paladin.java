...
public class Paladin extends Kit {
    ...
    public Paladin() {
        super(
                "Paladino",
                "kit.skywars.solo.paladin",
                "kit.skywars.team.paladin",
                5000,
                2500
        );
    }
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Seja um paladino e enfrente seus inimigos!");
        lore.add("");
        ...
        net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.DIAMOND_CHESTPLATE));
