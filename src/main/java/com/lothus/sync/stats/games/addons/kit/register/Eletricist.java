...
public class Eletricist extends Kit {

    public Eletricist() {
        super(
                "Eletricista",
                "kit.skywars.solo.eletricist",
                "kit.skywars.team.eletricist",
                5000,
                2500
        );
    }
    ...
    public void apply(Player player) {
        ...
        player.getInventory().addItem(new ItemStack(Material.PISTON_BASE, 16));
        player.getInventory().addItem(new ItemStack(Material.TNT, 5));
        player.getInventory().addItem(new ItemStack(Material.LEVER, 16));
        player.getInventory().addItem(new ItemStack(Material.STONE_PLATE, 16));
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Gosta de criar sistemas e engenhocas?");
        lore.add("§7Tenha um arsenal de coisas como Redstone");
        lore.add("§7e TNTs para fazer a festa!");
        lore.add("");
        ...
        net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.REDSTONE));
        ...
        meta.setDisplayName("§aEletricista");
        if (enchant) {
