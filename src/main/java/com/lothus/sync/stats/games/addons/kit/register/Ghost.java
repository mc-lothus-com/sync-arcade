...
public class Ghost extends Kit {
    ...
    public Ghost() {
        super(
                "Fantasma",
                "kit.skywars.solo.ghost",
                "kit.skywars.team.ghost",
                5000,
                2500
        );
    }
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Ataque seus inimigos de ");
        lore.add("§7forma sorrateira com sua poção de invisibilidade!");
        lore.add("");
        ...
        net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.GHAST_TEAR));
