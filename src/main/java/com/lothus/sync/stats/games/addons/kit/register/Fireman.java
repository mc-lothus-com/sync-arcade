...
public class Fireman extends Kit {
    ...
    public Fireman() {
        super(
                "Bombeiro",
                "kit.skywars.solo.fireman",
                "kit.skywars.team.fireman",
                5000,
                2500
        );
    }
    ...
    public void apply(Player player) {
        player.getInventory().addItem(new ItemStack(Material.WATER_BUCKET, 3));
        player.getInventory().addItem(new ItemStack(Material.POTION, 1, (byte) 8227));
    }
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Traga com você 3 baldes de água");
        lore.add("§7e uma poção que te protege do fogo!");
        lore.add("");
        ...
        net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.BLAZE_POWDER));
