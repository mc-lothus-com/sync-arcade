...
public class Lancer extends Kit {

    public Lancer() {
        super(
                "Lanceiro",
                "kit.skywars.solo.lancer",
                "kit.skywars.team.lancer",
                5000,
                2500
        );
    }
    ...
    public void apply(Player player) {
        player.getInventory().addItem(new ItemCreator(Material.GOLD_SWORD).addEnchant(Enchantment.KNOCKBACK, 1).build());
    }
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Faça seus inimigos voarem com sua ");
        lore.add("§7poderosa espada de ouro encantada com repulsão!");
        lore.add("");
        ...
        net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.GOLD_SWORD));
