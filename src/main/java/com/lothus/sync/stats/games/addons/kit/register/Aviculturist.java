...
public class Aviculturist extends Kit {

    public Aviculturist() {
        super(
                "Aviculturista",
                "kit.skywars.solo.aviculturist",
                "kit.skywars.team.aviculturist",
                5000,
                2500
        );
    }
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Atinja seus inimigos com ovos!");
        lore.add("");
        ...
        net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.EGG));
        ...
        meta.setDisplayName("§aAviculturista");
        if (enchant) {
