...
public class Lumberjack extends Kit {
    ...
    public Lumberjack() {
        super(
                "Lenhador",
                "kit.skywars.solo.lenhador",
                "kit.skywars.team.lenhador",
                5000,
                2500
        );
    }
    ...
    public void apply(Player player) {
        player.getInventory().addItem(
                new ItemCreator(Material.IRON_AXE).build()
        );
        player.getInventory().addItem(
                new ItemCreator(Material.LOG).setAmount(16).build()
        );
    }
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7A cada partida inicie com 16 madeiras.");
        lore.add("");
        ...
        net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.IRON_AXE));
