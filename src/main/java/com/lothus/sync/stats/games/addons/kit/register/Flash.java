...
public class Flash extends Kit {
    ...
    public Flash() {
        super(
                "Flash",
                "kit.skywars.solo.flash",
                "kit.skywars.team.flash",
                5000,
                2500
        );
    }
    ...
    public void apply(Player player) {
        player.getInventory().addItem(new ItemCreator(Material.POTION).setId(16418).setAmount(3).build());
    }
    ...
    public org.bukkit.inventory.ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Faça o rush mais rápido com poções de velocidade!");
        lore.add("");
        ...
        ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.POTION, 1, (short) 16418));
