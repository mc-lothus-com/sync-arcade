...
public class Witch extends Kit {
    ...
    public Witch() {
        super("Bruxo", "kit.skywars.solo.witch", "kit.skywars.team.witch", 7500, (7500 / 2));
    }

    @Override
    public void apply(Player player) {
        player.getInventory().addItem(new ItemCreator(Material.POTION).setId(16389).build());
        player.getInventory().addItem(new ItemCreator(Material.POTION).setId(16449).build());
        player.getInventory().addItem(new ItemCreator(Material.POTION).setId(16484).build());
        player.getInventory().addItem(new ItemCreator(Material.POTION).setId(16392).build());
    }
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Torne-se um bruxo e ataque");
        lore.add("§7todos a sua volta.");
        lore.add("");
        ...
        net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.POTION));
