...
public class Detonator extends Kit {

    public Detonator() {
        super(
                "Detonador",
                "kit.skywars.solo.detonator",
                "kit.skywars.team.detonator",
                5000,
                2500
        );
    }
    ...
    public void apply(Player player) {
        player.getInventory().addItem(new ItemStack(Material.TNT, 25));
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Explodir é seu hobbie!");
        lore.add("§7Use 25 explosivos para detonar tudo!");
        lore.add("");
        ...
        net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.TNT));
        ...
        meta.setDisplayName("§aDetonador");
        if (enchant) {
