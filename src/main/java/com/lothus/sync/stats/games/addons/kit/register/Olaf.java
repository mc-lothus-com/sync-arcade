...
public class Olaf extends Kit {

    public Olaf() {
        super(
                "Olaf",
                "kit.skywars.solo.olaf",
                "kit.skywars.team.olaf",
                5000,
                2500
        );
    }
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Conjure seu companheiro");
        lore.add("§7da neve para te ajudar no combate!");
        lore.add("");
        ...
        net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.SNOW_BALL));
