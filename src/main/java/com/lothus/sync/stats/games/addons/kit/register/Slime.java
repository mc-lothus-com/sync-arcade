...
public class Slime extends Kit {

    public Slime() {
        super(
                "Slime",
                "kit.skywars.solo.slime",
                "kit.skywars.team.slime",
                5000,
                2500
        );
    }
    ...
    public void apply(Player player) {
        player.getInventory().addItem(new ItemStack(Material.SLIME_BLOCK, 32));
    }
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Receba 32 blocos de slime!");
        lore.add("");
        ...
        net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.SLIME_BLOCK));
