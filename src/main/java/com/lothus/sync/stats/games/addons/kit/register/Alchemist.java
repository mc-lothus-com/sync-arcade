...
public class Alchemist extends Kit {
    ...
    public Alchemist() {
        super(
                "Alchemist",
                "kit.skywars.solo.alchemist",
                "kit.skywars.team.alchemist",
                5000,
                2500
        );
    }
    ...
    public void apply(Player player) {
        player.getInventory().addItem(new ItemCreator(Material.WEB).setAmount(32).build());
        player.getInventory().addItem(new ItemCreator(Material.POTION).setId(16426).build());
    }
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Atrapalhe seus inimigos com teias e poções!");
        lore.add("");
        ...
        meta.setDisplayName("§aAlquimista");
        if (enchant) {
