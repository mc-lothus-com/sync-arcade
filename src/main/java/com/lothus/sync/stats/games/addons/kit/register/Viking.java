...
public class Viking extends Kit {
    ...
    public Viking() {
        super(
                "Viking",
                "kit.skywars.solo.viking",
                "kit.skywars.team.viking",
                10000,
                5000
        );
    }
    ...
    public void apply(Player player) {
        player.getInventory().setChestplate(
                new ItemCreator(Material.IRON_CHESTPLATE)
                        .addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1)
                        .build()
        );
        player.getInventory().addItem(
                new ItemCreator(Material.DIAMOND_AXE).build()
        );
    }
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Torne se um Viking e ");
        lore.add("§7elimine todos seus inimigos.");
        lore.add("");
        ...
        net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.DIAMOND_AXE));
