...
public class Warrior extends Kit {
    ...
    public Warrior() {
        super(
                "Guerreiro",
                "kit.skywars.solo.warrior",
                "kit.skywars.team.warrior",
                5000,
                2500
        );
    }
    ...
    public void apply(Player player) {
        player.getInventory().addItem(new ItemCreator(Material.DIAMOND_SWORD).addEnchant(Enchantment.DAMAGE_ALL, 1).build());
    }
    ...
    public ItemStack getIcon(Player player, RoomType type) {
        ...
        lore.add("§7Empunhe uma mortífera espada de");
        lore.add("§7diamante com um encantamento de afiação!");
        lore.add("");
        ...
        net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(new org.bukkit.inventory.ItemStack(Material.DIAMOND_SWORD));
        ...
        meta.setDisplayName("§aGuerreiro");
        if (enchant) {
