package com.lothus.sync.stats.menus.games.skywars.slaughter;
...
import com.lothus.sync.stats.menus.games.skywars.slaughter.confirm.ConfirmSlaughterMenu;
...
public class SlaughterMenu extends AbstractMenu {
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        if (skyPlayer.hasSlaughter(slaughter)) {
            if (skyPlayer.getSlaughter().equalsIgnoreCase(slaughter.getIdentify())) {
            ...
            player.sendMessage("§eVocê mudou de §b" + (skyPlayer.getSlaughter() == "None" ? "Nenhum" : skyPlayer.getSlaughter()) + " §epara §b" + slaughter.getIdentify() + "§e.");
            skyPlayer.setSlaughter(slaughter.getIdentify());
