package com.lothus.sync.stats.menus.games.skywars.kits.solo;
...
import com.lothus.sync.stats.menus.games.skywars.kits.solo.confirm.ConfirmMenu;
...
public class KitsSoloMenu extends AbstractMenu {
    ...
    public void items(Player player) {
        ...
        for (Kit kit : Platform.getSkyPlatform().getKitController().getKits()) {
            ...
            inventory.setItem(slot, kit.getIconLoja(player, RoomType.SOLO));
        }
    }
