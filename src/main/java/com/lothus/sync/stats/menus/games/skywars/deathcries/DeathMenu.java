package com.lothus.sync.stats.menus.games.skywars.deathcries;
...
import com.lothus.sync.stats.menus.games.skywars.deathcries.confirm.ConfirmDeathMenu;
...
public class DeathMenu extends AbstractMenu {
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        if (skyPlayer.hasDeathCry(deathCry)) {
            if (skyPlayer.getDeathCry().equalsIgnoreCase(deathCry.getIdentify())) {
            ...
            player.sendMessage("§eVocê mudou de §b" + (skyPlayer.getDeathCry() == "None" ? "Nenhum" : skyPlayer.getDeathCry()) + " §epara §b" + deathCry.getIdentify() + "§e.");
            skyPlayer.setDeathCry(deathCry.getIdentify());
